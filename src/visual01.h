...
void Paths2Dot(FILE *dotput, const METSPACE &metspace, const RXNSPACE &rxnspace, const string label);
...
void visualizePathSummary2File(const string fileBase, const string label, const vector<PATHSUMMARY> &psum, const PROBLEM &ProblemSpace, int useSyns);
